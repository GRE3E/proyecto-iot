...
import { Settings, Globe, Bell, UserPlus, X, Mic } from "lucide-react"
import SimpleCard from "../UI/SimpleCard"
import Perfil from "./Perfil"
import type { FamilyMember } from "./Perfil"

// 🔧 Corrección para reconocimiento de voz (TS)
declare global {
  interface Window {
...
export default function Configuracion() {
  ...
  // Abre modal y prellena valores actuales
  ...
  const handleSaveProfile = () => {
    // Validación mínima
    const newName = modalOwnerName.trim()
    if (!newName) {
  ...
  return (
    <div className="font-inter max-w-5xl mx-auto space-y-6 relative">
      ...
      {/* Modal editar perfil del propietario */}
      {isProfileModalOpen && (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
          <div className="bg-slate-900 rounded-2xl p-6 w-[90%] max-w-md shadow-lg text-white relative">
            <button
            ...
            <h3 className="text-xl font-semibold mb-4">Editar perfil del propietario</h3>
      ...
      {isAddMemberModalOpen && (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
          <div className="bg-slate-900 rounded-2xl p-6 w-[90%] max-w-md shadow-lg text-white relative">
            ...
            <h3 className="text-xl font-semibold mb-3">Agregar nuevo familiar</h3>
            <p className="text-sm text-slate-400 mb-4">
              Para registrar, di claramente:{" "}
              <span className="text-blue-400 font-semibold">“Okay Murphy [nombre]”</span>.
            </p>
