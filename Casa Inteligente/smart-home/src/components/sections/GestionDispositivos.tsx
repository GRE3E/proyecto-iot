...
import { IconBolt, IconPin } from "../UI/Icons"

// Small inline sparkline (SVG) for energy trends
function Sparkline({ data = [180, 200, 240, 220, 210, 230, 250], className = "w-full h-12" }: { data?: number[]; className?: string }) {
...
export default function GestionDispositivos({ devices, setDevices, energyUsage, setEnergyUsage, filter, setFilter }: Props) {
  ...
  return (
    <div>
      ...
      {/* Tabs (ARIA-enabled) rendered below */}

      {/* Tabs */}
      <div className="mb-6 flex gap-3" role="tablist" aria-label="Gestion de Dispositivos Tabs">
        <button
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
            <SimpleCard className="p-4 text-center">
              <div className="w-10 h-10 mx-auto mb-2 bg-gradient-to-br from-green-400 to-emerald-500 rounded-lg flex items-center justify-center text-white text-lg font-bold shadow-sm">
                ✓
              </div>
            ...
            <SimpleCard className="p-4 text-center">
              <div className="w-10 h-10 mx-auto mb-2 bg-gradient-to-br from-red-400 to-rose-500 rounded-lg flex items-center justify-center text-white text-lg font-bold shadow-sm">
                ✕
              </div>
            ...
            <SimpleCard className="p-4 text-center">
              <div className="w-10 h-10 mx-auto mb-2 bg-gradient-to-br from-yellow-400 to-amber-500 rounded-lg flex items-center justify-center text-white text-lg font-bold shadow-sm">
            ...
            <SimpleCard className="p-4 text-center">
              <div className="w-10 h-10 mx-auto mb-2 bg-gradient-to-br from-blue-400 to-cyan-500 rounded-lg flex items-center justify-center text-white text-lg font-bold shadow-sm">
                ...
                <div className="flex justify-between items-start mb-6">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      >
                        {device.on ? <IconBolt className="w-5 h-5" /> : <span className="text-xl">💤</span>}
                      </div>
                      <div>
                    ...
                    <div className="space-y-2 ml-13">
                      <div className="flex items-center gap-2 text-sm text-slate-400">
                        <span className="w-4 h-4 bg-slate-700 rounded flex items-center justify-center text-xs"><IconPin className="w-3 h-3 text-slate-300" /></span>
                        {device.location}
                      </div>
                      <div className="flex items-center gap-2 text-sm text-slate-400">
                        <span className="w-4 h-4 bg-slate-700 rounded flex items-center justify-center text-xs"><IconBolt className="w-3 h-3 text-slate-300" /></span>
                        {device.power}
                      </div>
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 mt-8">
            ...
            <SimpleCard className="p-8">
              ...
              <div className="space-y-4">
                ...
                <div className="mt-4">
                  <p className="text-sm text-slate-300 mb-2">Tendencia últimos 7 días</p>
                  <div className="w-full h-12 bg-slate-900/30 rounded-lg p-2">
                    <Sparkline />
                  </div>
                </div>
              </div>
